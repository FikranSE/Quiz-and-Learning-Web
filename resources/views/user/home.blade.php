...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="/" class="logo d-flex align-items-center me-auto">
                <h1 class="sitename"><span style="color:#388da8;font-size:35px;">J</span>endela Literasi</h1>
            </a>

            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="/" class="">Home</a></li>
                    <li><a href="{{ route('client.test') }}">Test</a></li>
            ...
            <ul>
              ...
              <li><a href="#">Dropdown 4</a></li>
                    ...
                    @auth
                        ...
                        <li>
                            <a href="{{ route('logout') }}" class="nav-link text-center px-3"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                Logout
                            </a>
                        </li>
                        <li><a href="{{ route('admin.dashboard.index') }}"
                                class="nav-link text-center px-3">{{ auth()->user()->name }}</a></li>
                    @endauth
                </ul>
            ...
            <a class="btn-getstarted" href="test">Get Started</a>
        ...
        <section id="hero" class="hero section">
            ...
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h1 data-aos="fade-up" class="">Welcome to <span>Jendela Literasi</span></h1>
                    <p data-aos="fade-up" data-aos-delay="100" class="">Quickly start your project now and set the
                        stage for success<br></p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="test" class="btn-get-started">Get Started</a>
                        <a href="{{ route('videos.show') }}"class=" btn-watch-video d-flex align-items-center">
                    ...
                    <img src="{{ $ilustrasi && $ilustrasi->ilustrasi ? asset('storage/illustrations/' . $ilustrasi->ilustrasi) : asset('assets/img/bg.png') }}"
            ...
            <div class="container">
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-5 d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="content">
                            <h3>Tujuan Aplikasi Pembelajaran</h3>
                            <p>
                                {{ $ilustrasi && $ilustrasi->tujuan_pbl ? $ilustrasi->tujuan_pbl : '' }}
                            </p>
    ...
    <footer id="footer" class="footer position-relative">
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <span class="sitename">Jendela Literasi</span>
                    </a>
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">Jendela Literasi</strong><span>All Rights
                    Reserved</span></p>
            <div class="credits">
